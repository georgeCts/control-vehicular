    ...
    <div class="col-md-12 padding-20">
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                {!! Form::open(['route' => 'update-operador', 'method' => 'put' , 'id' => 'operadorForm', 'files' => true]) !!}
                    <input type="hidden" name="hddPkOperador" value="{{ $objOperador->pk_operador }}" />

                    <legend>INFORMACIÓN GENERAL</legend>
                    <div class="row form-group">
                        <div class="col-md-4">
                            <label for="txtNombre">Nombre Completo</label>
                            <input id="txtNombre" name="txtNombre" type="text" class="form-control" value="{{ $objOperador->nombre }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            <input id="txtTelefono" name="txtTelefono" type="text" class="form-control" value="{{ $objOperador->telefono }}" />
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            <input id="txtDomicilio" name="txtDomicilio" type="text" class="form-control" value="{{ $objOperador->domicilio }}" />
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            <input id="txtLicenciaFolio" name="txtLicenciaFolio" type="text" class="form-control" value="{{ $objOperador->licencia_folio }}" required />
                        </div>
                    ...
                    @if($objOperador->licencia_url != null)
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a href="{{ Storage::disk('s3')->url($objOperador->licencia_url) }}" target="_blank">
                                    <img src="{{ Storage::disk('s3')->url($objOperador->licencia_url) }}" class="img-thumbnail" width="30%" />
                                </a>
                            </div>
                        </div>
                    @endif
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var date =  '{{ $objOperador->licencia_vigencia }}';
