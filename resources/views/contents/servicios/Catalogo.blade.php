...
@section('panel')
    ...
    <div class="col-md-6 text-right m-t-20">
        <a href="/panel/servicios/agregar" class="btn btn-primary"><i class="fa fa-plus"></i> Agregar Servicio</a>
        <a href="/panel/servicios/bitacora" class="btn btn-dark"><i class="fa fa-book"></i> Bitácora</a>
        <a href="#" class="btn btn-dark"><i class="fa fa-clock-o"></i> Recordatorios</a>
    </div>
@endsection
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="responsive-table">
                    <table id="dtServicios" class="table table-striped" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach($lstServicios as $item)
                                <tr>
                                    <td class="text-center">{{ $item->pk_servicio }}</td>
                                    <td class="text-left">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <li><a href="/panel/servicios/editar/{{ $item->pk_servicio }}"><i class="fa fa-pencil"></i> Editar</a></li>
