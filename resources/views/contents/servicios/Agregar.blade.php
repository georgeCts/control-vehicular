    ...
    <div class="col-md-12 padding-20">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h4 class="text-white">AGREGAR SERVICIO</h4>
            </div>

            <div class="panel-body">
                {!! Form::open(['route' => 'new-servicio', 'method' => 'post' , 'id' => 'servicioForm']) !!}
                    ...
                    <div class="row form-group">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <textarea name="txtDescripcion" id="txtDescripcion" rows="5" class="form-control"></textarea>
                        </div>
                    </div>
