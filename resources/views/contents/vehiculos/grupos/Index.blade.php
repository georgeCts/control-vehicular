                    ...
                    <table id="dtVehiculosGrupos" class="table table-striped" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach($lstVehiculosGrupos as $itemGrupo)
                                <tr>
                                    <td class="text-center">{{ $itemGrupo->pk_vehiculo_grupo }}</td>
                                    <td class="text-left">{{ $itemGrupo->vehiculo_grupo }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <li><a href="/panel/vehiculos/editar_grupo/{{ $itemGrupo->pk_vehiculo_grupo }}"><i class="fa fa-pencil"></i> Editar</a></li>
