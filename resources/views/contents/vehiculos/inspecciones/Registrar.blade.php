...
@section('panel')
    ...
    <div class="col-md-6 text-right m-t-20">
        <a href="/panel/vehiculos/inspecciones/{{$objVehiculo->pk_vehiculo}}" class="btn btn-dark"><i class="fa fa-check"></i> Inspecciones</a>
    </div>
@endsection
    ...
    <div class="col-md-12 padding-20">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                {!! Form::open(['route' => 'new-inspeccion', 'method' => 'POST' , 'id' => 'inspeccionForm', 'files' => true]) !!}
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            <input id="txtTipoVehiculo" type="text" class="form-control" value="{{$objVehiculo->vehiculoTipo->vehiculo_tipo}}" readonly />
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12 text-center">
                            ...
                            <div style="display:none;">
                                <img id="source" src="{{asset('images/vehiculo.jpg')}}" width="500" height="500" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <a href="/panel/vehiculos/inspecciones/{{$objVehiculo->pk_vehiculo}}" role="button" class="btn btn-default">Cancelar</a>
                    </div>
                {!! Form::close() !!}
            </div>
        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/plugins/jSignature/jSignature.min.js') }}"></script>
