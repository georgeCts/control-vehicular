                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{(($objCredito->fecha_inicial)?$objCredito->fecha_inicial:'No registrado')}}
                                                </tr>
                                                <tr>
                                                    <td><small><strong>Fecha Final</strong></small></td>
                                                    <td>{{(($objCredito->fecha_final)?$objCredito->fecha_final:'No registrado')}}
                                                </tr>
                                                <tr>
                                                    <td><small><strong>Pago Mensual</strong></small></td>
                                                    <td>{{(($objCredito->pago_mensual)?$objCredito->pago_mensual:'No registrado')}}
                                                </tr>
                                                <tr>
                                                    <td><small><strong>Monto Financiado</strong></small></td>
                                                    <td>{{(($objCredito->monto_financiado)?$objCredito->monto_financiado:'No registrado')}}</td>
                                                </tr>
                                                <tr>
                                                    <td><small><strong>Tasa de Inter&eacute;s</strong></small></td>
                                                    <td>{{(($objCredito->tasa_interes)?$objCredito->tasa_interes:'No registrado')}}</td>
                                                </tr>
                                                <tr>
                                                    <td><small><strong>Valor Residual</strong></small></td>
                                                    <td>{{(($objCredito->valor_residual)?$objCredito->valor_residual:'No registrado')}}</td>
                                                </tr>
                                                <tr>
                                                    <td><small><strong>Instituci&oacute;n Financiera</strong></small></td>
                                                    <td>{{(($objCredito->institucion_financiera)?$objCredito->institucion_financiera:'No registrado')}}</td>
                                                </tr>
                                                <tr>
                                                    <td><small><strong>No. de Cuenta</strong></small></td>
                                                    <td>{{(($objCredito->numero_cuenta)?$objCredito->numero_cuenta:'No registrado')}}</td>
                                                </tr>
                                                <tr>
                                                    <td><small><strong>Notas</strong></small></td>
