...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        view()->share('_PAGE_TITLE', 'miFlota.mx');
        view()->share('_SYSTEM_NAME', 'miFlota Panel'); 
        View()->share('_SYSTEM_FULL_NAME', 'Sistema de Gestión de Flotilas');
        View()->share('_SYSTEM_DESCRIPTION', 'La forma fácil de administrar tus unidades');
