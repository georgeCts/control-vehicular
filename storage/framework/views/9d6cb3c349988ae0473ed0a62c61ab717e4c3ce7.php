...
<head>
  ...
  <title><?php echo e($_PAGE_TITLE); ?></title>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/plugins/icheck/skins/flat/aero.css')); ?>"/>
  <link href="<?php echo e(asset('assets/css/style.css')); ?>" rel="stylesheet">
  <!-- end: Css -->

  <link rel="shortcut icon" href="<?php echo e(asset('assets/img/logomi.png')); ?>">
...
<body id="mimin" class="dashboard form-signin-wrapper">
    ...
    <div class="container">
        ...
        <?php if(Session::has('login_error_message')): ?>
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="alert alert-warning col-md-12 col-sm-12 alert-icon alert-dismissible fade in" role="alert">
                        ...
                        <div class="col-md-10 col-sm-10">
                            ...
                            <p><strong><?php echo e(Session::get('login_error_title' )); ?></strong> <br /> <?php echo e(Session::get('login_error_message' )); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <?php echo Form::open(['route' => 'login-panel', 'class' => 'form-signin']); ?>

            <div class="panel periodic-login">
                <div class="panel-body text-center">
                    <h1 class="atomic-symbol">Mi</h1>
                    <p class="atomic-mass"><?php echo e($_SYSTEM_VERSION); ?></p>
    ...
    <script src="<?php echo e(asset('assets/js/plugins/icheck.min.js')); ?>"></script>
