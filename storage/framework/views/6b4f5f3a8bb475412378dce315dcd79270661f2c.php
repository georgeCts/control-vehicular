    ...
    <div class="col-md-12 padding-20">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h4 class="text-white">MODIFICAR GRUPO DE VEH&Iacute;CULO (<?php echo e($objVehiculoGrupo->vehiculo_grupo); ?>)</h4>
            </div>

            <div class="panel-body">
                <?php echo Form::open(['route' => 'update-grupo-vehiculo', 'method' => 'put' , 'id' => 'grupoVehiculoForm']); ?>

                    <input type="hidden" name="hddPkVehiculoGrupo" value="<?php echo e($objVehiculoGrupo->pk_vehiculo_grupo); ?>" />
                    <div class="row form-group">
                        <div class="col-md-3 col-sm-6">
                            <label for="txtNombre">Nombre</label>
                            <input id="txtNombre" name="txtNombre" type="text" class="form-control" value="<?php echo e($objVehiculoGrupo->vehiculo_grupo); ?>" required />
                        </div>
                    </div>                                        
