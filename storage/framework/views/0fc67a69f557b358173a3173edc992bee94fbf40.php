                    ...
                    <table id="dtVehiculosTipos" class="table table-striped" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lstVehiculosTipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemTipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-center"><?php echo e($itemTipo->pk_vehiculo_tipo); ?></td>
                                    <td class="text-left"><?php echo e($itemTipo->vehiculo_tipo); ?></td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            <li><a href="/panel/vehiculos/editar_tipo/<?php echo e($itemTipo->pk_vehiculo_tipo); ?>"><i class="fa fa-pencil"></i> Editar</a></li>
