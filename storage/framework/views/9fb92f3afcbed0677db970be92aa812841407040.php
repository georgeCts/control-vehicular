    ...
    <div class="col-md-12 padding-20">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php echo Form::open(['route' => 'new-proveedor', 'method' => 'post' , 'id' => 'proveedorForm']); ?>

                    <legend>INFORMACIÓN GENERAL</legend>
                    <div class="row form-group">
                        <div class="col-md-4">
                            <label for="txtNombreComercial">Nombre Comercial</label>
                            <input id="txtNombreComercial" name="txtNombreComercial" type="text" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            <input id="txtCiudad" name="txtCiudad" type="text" class="form-control">
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            ...
                            <input id="txtContacto" name="txtContacto" type="text" class="form-control">
                        </div>

                        <div class="col-md-4">
                            <label for="txtContactoTelefono">Tel&eacute;fono</label>
                            <input id="txtContactoTelefono" name="txtContactoTelefono" type="text" class="form-control">
                        </div>

                        <div class="col-md-4">
                            <label for="txtContactoCorreo">Correo Electr&oacute;nico</label>
                            <input id="txtContactoCorreo" name="txtContactoCorreo" type="text" class="form-control">
                        </div>
                    </div>
