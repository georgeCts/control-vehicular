    ...
    <div class="container">
        ...
        <table width="100%" cellpadding="2" cellspacing="0">
            <tr>
                ...
                <td class="celdaH4" width="15%" style="text-align:center"><?php echo e($objInspeccion->fecha_inspeccion); ?> </td>

                <td class="tituloBoldTH4" width="15%" style="text-align: left;">Kilometraje de salida</td>
                <td class="celdaH4" width="15%" style="text-align:center"><?php echo e($objInspeccion->kilometraje_salida); ?> Kms.</td>

                <td class="tituloBoldTH4" width="20%" style="text-align: left;">N&uacute;mero de las placas</td>
                <td class="celdaH4" width="20%" style="text-align:center"><?php echo e($objInspeccion->vehiculo->vehiculo_placa); ?> </td>
            </tr>
            <tr>
                <td class="tituloBoldTH4" width="15%" style="text-align: left;">Conductor</td>
                <td class="celdaH4" width="15%" style="text-align:center"><?php echo e($objInspeccion->operador->nombre); ?> </td>

                <td class="tituloBoldTH4" width="15%" style="text-align: left;">Vigencia de licencia</td>
                <td class="celdaH4" width="15%" style="text-align:center"><?php echo e($objInspeccion->vigencia_licencia); ?></td>

                <td class="tituloBoldTH4" width="20%" style="text-align: left;">N&uacute;mero de la unidad</td>
                <td class="celdaH4" width="20%" style="text-align:center"><?php echo e($objInspeccion->numero_unidad); ?> </td>
            </tr>
            <tr>
                <td class="tituloBoldTH4" width="15%" style="text-align: left;">Tipo de veh&iacute;culo</td>
                <td class="celdaH4" width="15%" style="text-align:center"><?php echo e($objInspeccion->vehiculo->vehiculoTipo->vehiculo_tipo); ?> </td>

                <td class="tituloBoldTH4" width="15%" style="text-align: left;">Kilometraje de llegada</td>
                <td class="celdaH4" width="15%" style="text-align:center"><?php echo e($objInspeccion->kilometraje_llegada); ?> Kms.</td>

                <td class="tituloBoldTH4" width="20%" style="text-align: left;">N&uacute;mero de tel&eacute;fono de veh&iacute;culo</td>
                <td class="celdaH4" width="20%" style="text-align:center"><?php echo e($objInspeccion->telefono_vehiculo); ?> </td>
            </tr>
        </table>
        <br />
        ...
        <table style="page-break-after: always;" width="100%" cellpadding="2" cellspacing="0">
            ...
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->triangulos_reflejantes == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->triangulos_reflejantes == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                
                <td class="celdaH4" width="30%" style="text-align:left">Nivel de combustible (Lleno, 1/4, 1/2, 3/4, E)</td>
                <td class="celdaH4" width="20%" colspan="2" style="text-align: center;"><?php echo e($objInspeccion->nivel_combustible); ?></td>
            </tr>
            <tr>
                <td class="celdaH4" width="30%" style="text-align: left;">Gato</td>
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->gato == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->gato == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->nivel_anticongelante == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->nivel_anticongelante == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->herramientas == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->herramientas == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->nivel_aceite == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->nivel_aceite == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->llanta_refaccion == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->llanta_refaccion == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->liquido_limpiador == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->liquido_limpiador == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->fuga_visible == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->fuga_visible == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->presion_llantas == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->presion_llantas == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->cables_corriente == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->cables_corriente == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->dibujo_llantas == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->dibujo_llantas == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            ...
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->limpieza == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->limpieza == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->luces_delanteras == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->luces_delanteras == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->aseguramiento_carga == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->aseguramiento_carga == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->luces_traseras == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->luces_traseras == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->dano_carroceria == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->dano_carroceria == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->luces_intermitentes == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->luces_intermitentes == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->condicion_escape == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->condicion_escape == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            ...
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->limpiaparabrisa == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->limpiaparabrisa == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->tarjeta_circulacion == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->tarjeta_circulacion == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->parabrisa == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->parabrisa == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->poliza_seguro == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->poliza_seguro == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->aire_acondicionado == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->aire_acondicionado == 0): ?>
                        X
                    <?php endif; ?>
                </td>
                ...
                <td class="celdaH4" width="10%" style="text-align:center">
                    <?php if($objInspeccion->registro_mantenimiento == 1): ?>
                        X
                    <?php endif; ?>
                </td>
                <td class="celdaH4" width="10%" style="text-align: center;">
                    <?php if($objInspeccion->registro_mantenimiento == 0): ?>
                        X
                    <?php endif; ?>
                </td>
            </tr>
        ...
        <table width="100%" cellpadding="2" cellspacing="0">
            ...
            <tr><td class="celdaH4" width="100%" height="600px" style="text-align:left"><?php echo e($objInspeccion->comentarios); ?> </td></tr>
        </table>
        <br />
        ...
        <table width="100%" cellpadding="2" cellspacing="0">
            <tr>
                <td class="celdaH4" width="100%">
                    ...
                    <br />
                    <img style="text-align: center;" width="350px" src="<?php echo e(Storage::disk('s3')->url($objInspeccion->imagen_dano)); ?>" />
                </td>
            </tr>
        </table>
        <br />
        ...
        <table width="100%" cellpadding="2" cellspacing="0">
            <tr>
                <td width="100%" style="text-align: left;">
                    ...
                    <img width="300px" src="<?php echo e(Storage::disk('s3')->url($objInspeccion->url_firma_entrega)); ?>" />
                    <span><?php echo e($objInspeccion->usuarioEntrega->nombre); ?> <?php echo e($objInspeccion->usuarioEntrega->apellido_paterno); ?> <?php echo e($objInspeccion->usuarioEntrega->apellido_materno); ?></span>
                </td>

                <td width="100%" style="text-align: right;">
                    <h4>Nombre y firma de quien recibe</h4>
                    <img width="300px" src="<?php echo e(Storage::disk('s3')->url($objInspeccion->url_firma_recibe)); ?>" />
                    <span><?php echo e($objInspeccion->operadorRecibe->nombre); ?> <?php echo e($objInspeccion->operadorRecibe->apellido_paterno); ?> <?php echo e($objInspeccion->operadorRecibe->apellido_materno); ?></span>
                </td>
            </tr>
        </table>
        <br />
        ...
        <table width="100%" cellpadding="2" cellspacing="0">
            <tr>
                <td width="100%">                                        
                    <img width="100px" src="data:image/png;base64,<?php echo e(DNS2D::getBarcodePNG($objInspeccion->pk_vehiculo_inspeccion, 'QRCODE')); ?>" alt="barcode" />
                    <br />
