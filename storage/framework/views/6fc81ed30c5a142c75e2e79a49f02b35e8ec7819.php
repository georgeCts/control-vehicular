    ...
    <div class="col-md-12 padding-20">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h4 class="text-white">MODIFICAR TIPO DE VEH&Iacute;CULO (<?php echo e($objVehiculoTipo->vehiculo_tipo); ?>)</h4>
            </div>

            <div class="panel-body">
                <?php echo Form::open(['route' => 'update-tipo-vehiculo', 'method' => 'put' , 'id' => 'tipoVehiculoForm']); ?>

                    <input type="hidden" name="hddPkVehiculoTipo" value="<?php echo e($objVehiculoTipo->pk_vehiculo_tipo); ?>" />
                    <div class="row form-group">
                        <div class="col-md-3 col-sm-6">
                            <label for="txtNombre">Nombre</label>
                            <input id="txtNombre" name="txtNombre" type="text" class="form-control" value="<?php echo e($objVehiculoTipo->vehiculo_tipo); ?>" required />
                        </div>
                    </div>                                        
